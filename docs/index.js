...
var printDocASTReducer = {
  ...
  InterfaceTypeDefinition: addDescription(function(_ref26) {
    ...
    return join(["interface", name, wrap2("implements ", join(interfaces, " & ")), join(directives, " "), block(fields)], " ");
  }),
  ...
  InterfaceTypeExtension: function InterfaceTypeExtension(_ref35) {
    ...
    return join(["extend interface", name, wrap2("implements ", join(interfaces, " & ")), join(directives, " "), block(fields)], " ");
  },
...
function filterOperationVariables(variables, query2) {
...
function selectHttpOptionsAndBodyInternal(operation, printer) {
  ...
  if (http.includeQuery)
    body.query = printer(query2, print2);
  return {
    options,
    body
  };
  ...
  function() {
    ...
    StoreReader2.prototype.diffQueryAgainstStore = function(_a2) {
      ...
      var execResult = this.executeSelectionSet({
        ...
        context: __assign({ store, query: query2, policies, variables, varString: canonicalStringify(variables), canonizeResults }, extractFragmentContext(query2, this.config.fragments))
      });
      var missing;
      if (execResult.missing) {
        missing = [
          new MissingFieldError(firstMissing(execResult.missing), execResult.missing, query2, variables)
        ];
...
var StoreWriter = (
  ...
  function() {
    ...
    StoreWriter2.prototype.writeToStore = function(store, _a2) {
      var _this = this;
      var query2 = _a2.query, result2 = _a2.result, dataId = _a2.dataId, variables = _a2.variables, overwrite = _a2.overwrite;
      ...
      }, variables, varString: canonicalStringify(variables) }, extractFragmentContext(query2, this.fragments)), { overwrite: !!overwrite, incomingById: /* @__PURE__ */ new Map(), clientOnly: false, deferred: false, flavors: /* @__PURE__ */ new Map() });
...
function equalByQuery(query2, _a2, _b, variables) {
...
var ObservableQuery = (
  ...
  function(_super) {
    ...
    ObservableQuery2.prototype.fetch = function(options, newNetworkStatus, query2) {
      this.queryManager.setObservableQuery(this);
      return this.queryManager["fetchConcastWithInfo"](this.queryId, options, newNetworkStatus, query2);
    };
    ...
    ObservableQuery2.prototype.reobserveAsConcast = function(newOptions, newNetworkStatus) {
      ...
      var query2 = this.transformDocument(options.query);
      ...
      var _a2 = this.fetch(options, newNetworkStatus, query2), concast = _a2.concast, fromLink = _a2.fromLink;
      var observer = {
        next: function(result2) {
...
var QueryManager = (
  ...
  function() {
    ...
    QueryManager2.prototype.watchQuery = function(options) {
      var query2 = this.transform(options.query);
      options = __assign(__assign({}, options), { variables: this.getVariables(query2, options.variables) });
    ...
    QueryManager2.prototype.startGraphQLSubscription = function(_a2) {
      var _this = this;
      var query2 = _a2.query, fetchPolicy = _a2.fetchPolicy, _b = _a2.errorPolicy, errorPolicy = _b === void 0 ? "none" : _b, variables = _a2.variables, _c = _a2.context, context = _c === void 0 ? {} : _c;
      ...
      if (this.getDocumentInfo(query2).hasClientExports) {
    ...
    QueryManager2.prototype.fetchConcastWithInfo = function(queryId, options, networkStatus, query2) {
      var _this = this;
    ...
    QueryManager2.prototype.fetchQueryByPolicy = function(queryInfo, _a2, networkStatus) {
      ...
      var resultsFromCache = function(diff2, networkStatus2) {
        ...
        if (data && _this.getDocumentInfo(query2).hasForcedResolvers) {
          return _this.localState.runResolvers({
            document: query2,
            remoteResult: { data },
            context,
